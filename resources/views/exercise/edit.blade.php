            ...
            <form class="form-horizontal" enctype="multipart/form-data" name="exercise" method="post" action="{{ route('exercise.postupdate', ['id' => $exercise->id]) }}">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" name="exercise" method="post" action="{{ route('exercise.store') }}">
                    ...
                    <div class="form-group @error('exerciseDescription') has-error @enderror">
                        <label for="exerciseDescription" class="col-md-2">@lang('label.editExerciseDescription') <strong>@lang('label.mandatorySymbol')</strong></label>
                        <div class="col-md-10">
                            @if(isset($exercise->id))
                    ...
                    <div class="form-group @error('exerciseImportantNotes') has-error @enderror">
                        <label for="exerciseImportantNotes" class="col-md-2">@lang('label.editExerciseImportantNotes') <strong>@lang('label.mandatorySymbol')</strong></label>
                        <div class="col-md-10">
                            @if(isset($exercise->id))
