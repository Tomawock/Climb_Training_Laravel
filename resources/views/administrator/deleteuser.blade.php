...
<li><a href="{{ route('administrator.userslist') }}">@lang('label.administratorPage')</a></li>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class='panel-body'>
                    ...
                    <p><a class="btn btn-default" href="{{ route('administrator.userslist') }}"><span class='glyphicon glyphicon-log-out'></span> @lang('label.destroyUserBackMessage')</a></p>
                </div>
            </div>
        </div>
