        ...
        <div class="col-md-12">
            <div class="panel panel-default ">
                ...
                <div class="panel-body text-center panel-relative">
                    <h4 id="description"><?php echo e($trainingprogram->description); ?></h4>
                </div>
                <!-- Table -->
                <div class="col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomawock/code/Climb_Training_Laravel/resources/views/trainingprogram/show.blade.php ENDPATH**/ ?>